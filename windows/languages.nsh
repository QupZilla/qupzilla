...
LangString DESC_SecProtocols ${LANG_TRADCHINESE} "Associate QupZilla with http(s) and ftp protocols"
...
LangString MSG_InstallationCanceled ${LANG_TRADCHINESE} "Process cancelled by user."
