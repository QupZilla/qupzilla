...
{
    if (online) {
        setPixmap(QIcon::fromTheme("network-connect", QIcon(":sbi/data/network-online.png")).pixmap(16));
    }
    else {
        setPixmap(QIcon::fromTheme("network-disconnect", QIcon(":sbi/data/network-offline.png")).pixmap(16));
    }
