...
{
    if (enabled) {
        setPixmap(QIcon::fromTheme("security-high", QIcon(QSL(":icons/other/adblock.png"))).pixmap(16));
    }
    else {
        setPixmap(QIcon::fromTheme("security-low", QIcon(QSL(":icons/other/adblock-disabled.png"))).pixmap(16));
    }
